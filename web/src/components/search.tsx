...
export function Search({ className = '', placeholder }: SearchProps) {
  ...
  return (
    <Button
      variant='outline'
      className={cn(
        'bg-muted/25 group text-muted-foreground hover:bg-[rgba(232,163,61,0.07)] hover:text-primary hover:border-[rgba(232,163,61,0.35)] relative h-8 w-full flex-1 justify-start rounded-md border border-transparent text-sm font-normal shadow-none transition-colors sm:w-40 sm:pe-12 md:flex-none lg:w-52 xl:w-64',
        className
      )}

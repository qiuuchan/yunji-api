...
export function LogStatCards(props: LogStatCardsProps) {
  ...
  return (
    <div className='glass-panel overflow-hidden rounded-lg border border-[rgba(110,91,255,0.14)]'>
        ...
        {items.map((it, idx) => {
          ...
          if (loading) {
            ...
            valueContent = (
              <>
                <div
                  className='text-primary glow-cyan mt-1 max-w-full truncate font-mono text-base leading-tight font-bold tracking-tight tabular-nums sm:mt-2 sm:text-2xl sm:leading-normal'
                  title={it.fullValue}
                >
                  {it.value}
                </div>

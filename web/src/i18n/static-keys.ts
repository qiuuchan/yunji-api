...
export const STATIC_I18N_KEYS = [
  ...
  // Invoices (admin + wallet billing history)
  'Invoice',
  'Invoices',
  'Apply for Invoice',
  'Invoice Title',
